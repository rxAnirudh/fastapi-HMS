...
async def add_bill(bill_photo: list[UploadFile], patient_id: str = Form(default=''), doctor_charge: str = Form(default=''), medicine_charge: str = Form(default=''),
...
async def update_bill_details(bill_photo: list[UploadFile], patient_id: str = Form(default=''), doctor_charge: str = Form(default=''), medicine_charge: str = Form(default=''),
                      room_charge: str = Form(default=''), operation_charge: str = Form(default=""),
                      nursing_charge: str = Form(default=''), lab_charge: str = Form(default=""),
                      insurance_number: str = Form(default=''), total_bill: str = Form(default=""),
                      bill_date: str = Form(default=str(datetime.utcnow())), hospital_id: str = Form(default=""),
